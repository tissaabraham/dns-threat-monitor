# Database Classes & Tables - Complete Explanation

## Overview
This document provides a comprehensive explanation of all database classes and tables used in the DNS Threat Monitor system, including their structure, purpose, and how they work together.
...
- **Implementation**: `database/database.py` (673 lines)
- **Detailed Docs**: `database/README_DETAILED.md` (530 lines)
...
1. Review the classes in `database/database.py`
2. Understand how they interact with tables
3. Use in Detection Engine for threat tracking
4. Integrate with Dashboard for visualization
5. Use alert_history for compliance reporting
